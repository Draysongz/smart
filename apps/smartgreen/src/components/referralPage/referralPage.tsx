...
//         const userPromises = userData?.referrals.map(async (referredUserId: number) => {
//           const q = query(collection(db, "smart"), where("userId", "==", referredUserId));
...
//         setReferredUsers(users.filter((user) => user !== null));
//       }
//     };
